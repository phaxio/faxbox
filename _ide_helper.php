...
namespace {
    ...
    class Permission extends \Faxbox\Facades\Permission{
         ...
         */
        public static function all(){
            return \Faxbox\Repositories\Permission\PermissionRepository::all();
        }
         ...
         * @static 
         */
        public static function allWithChecked($checkedPermissions = array(), $default = -1){
            return \Faxbox\Repositories\Permission\PermissionRepository::allWithChecked($checkedPermissions, $default);
        }
        ...
        public static function name($resourceClass, $permission, $id = null){
            return \Faxbox\Repositories\Permission\PermissionRepository::name($resourceClass, $permission, $id);
        }
